...
/**
 * Created by cuieney on 2016/8/3.
 */
    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = MainApp.getInstance().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = MainApp.getInstance().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
