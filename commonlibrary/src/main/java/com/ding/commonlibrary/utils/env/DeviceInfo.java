package com.ding.commonlibrary.utils.env;
...
public class DeviceInfo {
    ...
    public static String getIMEI() {
        String deviceId = "";
        if (MainApp.getInstance().checkCallingOrSelfPermission(permission.READ_PHONE_STATE) == PackageManager.PERMISSION_GRANTED) {
            TelephonyManager telManager = (TelephonyManager) MainApp.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getCountoryCode() {
        TelephonyManager tm = (TelephonyManager) MainApp.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getLanguage() {
        String countoryLanguage = MainApp.getInstance().getResources().getConfiguration().locale.getCountry();
    ...
    public static String getNetworkTypeName() {
        ConnectivityManager connManager = (ConnectivityManager) MainApp.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int[] getDesity() {
        ...
        WindowManager windowManager = (WindowManager) MainApp.getInstance().getSystemService(Context.WINDOW_SERVICE);
